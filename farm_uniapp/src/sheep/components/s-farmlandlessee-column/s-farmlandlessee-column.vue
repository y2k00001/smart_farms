...
<template>
  <view class="ss-goods-wrap">
    ...
    >
      ...
      <image class="lg-img-box" :src="isArray(data.files) ? data.files[0].url : data.files" mode="aspectFill"></image>
      <view class="lg-goods-content ss-flex-1 ss-flex-col ss-row-between ss-p-b-10 ss-p-t-20">
        <view>
          ...
          <view
              ...
              :style="[{ color: subTitleColor, background: subTitleBackground }]"
          >
            租赁地块:{{ farmlandLessee.landArea.landAreaName }}
          </view>
          <!--服务类型，租赁周期-->
          ...
          <view
              ...
              :style="[{ color: subTitleColor, background: subTitleBackground }]"
          >
            服务类型:{{ farmlandLessee.landService.serviceName }}-{{farmlandLessee.lesseeDay}}天
          </view>
        ...
        <view>
          ...
          <view class="ss-flex ss-col-bottom ss-m-t-10">
            ...
            >
              ...
              <view class="ss-m-l-8">{{ farmlandLessee.lesseeAmount }}</view>
            </view>
          </view>
      ...
      <slot name="cart">
        <view class="buy-box ss-flex ss-col-center ss-row-center"
              v-if="props.farmlandLessee.status === 0 "     @tap.stop="continuePay">
          继续支付
        </view>
        <view class="planting-box ss-flex ss-col-center ss-row-center"
              v-if="props.farmlandLessee.status === 1 "     @tap.stop="continuePay">
          种植中
        </view>
        <view class="finish-box ss-flex ss-col-center ss-row-center"
              v-if="props.farmlandLessee.status === 2 "     @tap.stop="continuePay">
          已结束
        </view>
      </slot>
    </view>
...
<script setup>
  ...
  if(props.farmlandLessee.status !== 0){
