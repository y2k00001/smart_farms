  ...
  <view class="ss-goods-wrap">
    ...
    >
      <view v-if="tagStyle.show" class="tag-icon-box">
        <image class="tag-icon" :src="'https://smart-farms.oss-cn-shenzhen.aliyuncs.com/storage/upload/farmland1.png'"></image>
      </view>
      <image class="xs-img-box" :src="'https://smart-farms.oss-cn-shenzhen.aliyuncs.com/storage/upload/farmland1.png'" mode="aspectFit"></image>
      <view
    ...
    <view v-if="size === 'sm'" class="sm-goods-card ss-flex-col" :style="[elStyles]" @tap="onClick">
      ...
      <image class="sm-img-box" :src="'https://smart-farms.oss-cn-shenzhen.aliyuncs.com/storage/upload/farmland1.png'" mode="aspectFill"></image>
    ...
    <view v-if="size === 'md'" class="md-goods-card ss-flex-col" :style="[elStyles]" @tap="onClick">
      <view v-if="tagStyle.show" class="tag-icon-box">
        <image class="tag-icon" :src="props.data.coverFile"></image>
      </view>
      <view>
        <image
          class="md-img-box"
          :src="props.data.coverFile"
          mode="widthFix"
    ...
    >
      ...
      <image class="lg-img-box" :src="'https://smart-farms.oss-cn-shenzhen.aliyuncs.com/storage/upload/farmland1.png'" mode="aspectFill"></image>
...
<style lang="scss" scoped>
  ...
  .md-goods-card {
    ...
    .play-button {
      ...
      cursor: pointer;
      /* Add your play icon using CSS or font-awesome here */
    }
